...
//
// New regions get the globally-capable layers and nothing else. Transport,
// berths, cameras and facilities each need a national data agreement and stay
// Sydney-only. Counted 2026-08-17 off the built regions: 6 layers here against
// Sydney's 12, the difference being berths, transport, cameras, fires, weather
// and facilities. These are thinner pictures than the flagship and the
// interface should not imply otherwise. (vessels left that list on 2026-09-19:
// the layer gained a keyless worldwide AIS source, so it is global the same way
// hotspots is.)
//
...
// configured, not inferred — `PHILOTAS_WARM_REGIONS` defaults to `sydney` alone
...
// PHILOTAS_WARM_REGIONS unset and pins `_warmRegions()` to `['sydney']`, and
