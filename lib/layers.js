...
// Colours track the Bluebird palette measured from horizon.axoquant.com:
// royal #5D4FFF, bloom #0787D9, cyan #7EF9FF against a #0B1B33 page.
// The maritime layers take the cyan end of the ramp so the sea domain reads as
// one family against the air and land layers.
const CORE_LAYERS = [
  ...
  { id: 'vessels',    color: '#7EF9FF', label: 'Vessels',                type: 'vessel', trail: true },
  ...
  { id: 'transport',  color: '#5D4FFF', label: 'Public transport (live)', type: 'vehicle', trail: true },
...
export const VESSEL_TYPES = [
  { id: 'passenger', label: 'Ferry / passenger', color: '#7EF9FF' },
  ...
  { id: 'pilot',     label: 'Pilot',             color: '#4FC1F0' },
  { id: 'pleasure',  label: 'Pleasure craft',    color: '#9FB2CC' },
  { id: 'unknown',   label: 'Unknown',           color: '#7E93AD' },
];

export const TRANSPORT_MODES = [
  { id: 'Ferry',      label: 'Ferry',      color: '#7EF9FF' },
  { id: 'Train',      label: 'Train',      color: '#5D4FFF' },
  { id: 'Bus',        label: 'Bus',        color: '#0787D9' },
  { id: 'Light rail', label: 'Light rail', color: '#8B81FF' },
  { id: 'Metro',      label: 'Metro',      color: '#4FC1F0' },
];
...
// internal source id. `stored` is position history written by parallax-ingest,
...
const VESSEL_SOURCE_LABELS = {
  ...
  stored: 'parallax-ingest — recorded position',
};
